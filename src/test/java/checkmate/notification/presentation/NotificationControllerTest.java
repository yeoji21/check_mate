        ...
        mockMvc.perform(get("/notification/goal-complete")
                ...
                .andDo(document("find-goal-complete",
                        responseFields(
                                ...
                                fieldWithPath("notifications[].notificationType").type(JsonFieldType.STRING).description("푸쉬 알림 종류"),
        ...
        mockMvc.perform(get("/notification/{notificationId}", 1L)
                ...
                .andDo(document("read-notification",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("notificationType").type(JsonFieldType.STRING).description("푸쉬 알림 종류"),

...
class UserQueryServiceTest {
    ...
    void 닉네임_중복_통과_테스트() throws Exception {
        ...
        //when
        userQueryService.existsNicknameCheck("notExistsNickname");
        //then
    ...
    void 닉네임_중복_예외_테스트() throws Exception {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> userQueryService.existsNicknameCheck("existsNickname"));
        verify(userRepository).findByNickname(any(String.class));

...
public interface MateCommandMapper {
    ...
    InviteSendNotificationDto toNotificationDto(long inviterUserId, String inviterNickname,
        Mate invitee);
    ...
    InviteAcceptNotificationDto toAcceptNotificationDto(Mate invitee, String inviteeNickname,
        long inviterUserId);
    ...
    InviteRejectNotificationDto toRejectNotificationDto(Mate invitee, String inviteeNickname,
        long inviterUserId);
}

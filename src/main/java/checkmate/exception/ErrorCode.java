...
public enum ErrorCode {
    ...
    INVALID_WEEK_DAYS(GoalCode.WEEK_DAYS.getCode(), BAD_REQUEST, GoalCode.WEEK_DAYS.getMessage()),
    INVALID_GOAL_DATE(GoalCode.DATE.getCode(), BAD_REQUEST, GoalCode.DATE.getMessage()),
    ...
    EXCEED_GOAL_INVITEABLE_DATE(GoalCode.INVITEABLE_DATE.getCode(), BAD_GATEWAY, GoalCode.INVITEABLE_DATE.getMessage()),

...
public class NotificationController {
    ...
    public NotificationAttributeInfo findNotificationInfo(@PathVariable long notificationId,
    ...
    public NotificationAttributeInfoResult goalCompleteNotifications(@AuthenticationPrincipal JwtUserDetails userDetails) {

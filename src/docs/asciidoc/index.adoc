...
include::{snippets}/mate-calendar/path-parameters.adoc[]

=== Response Field

include::{snippets}/mate-calendar/response-fields.adoc[]

=== HTTP Response

include::{snippets}/mate-calendar/http-response.adoc[]
